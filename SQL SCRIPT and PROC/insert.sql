...
/****** Object:  StoredProcedure [dbo].[uspInsertSAPIntegrationData]    Script Date: 03/04/2018 12:19:04 PM ******/
DROP PROCEDURE [dbo].[uspInsertSAPIntegrationData]
GO
...
CREATE proc [dbo].[uspInsertSAPIntegrationData]
(
...
ON (T.SAP_ID=S.SAP_ID AND T.Legacy_ID=S.Legacy_ID AND T.FirstName=S.FirstName AND T.LastName=S.LastName AND T.DateOfBirth=S.DateOfBirth
...
(S.SAP_ID,S.Legacy_ID,S.FirstName,S.LastName,S.DateOfBirth,S.Pincode,S.Address1,S.Address2,S.Mobile_No,S.UnknownColumn1,S.Designation_PlaceOfPosting,S.
