...
{
    public sealed class SQLHelperClass
    {
        private static readonly Lazy<SQLHelperClass> instance = new Lazy<SQLHelperClass>(() => new SQLHelperClass());
        
        private Logs _logs = Logs.GetInstance;
        private SQLHelperClass()
        {

        }
        public static SQLHelperClass GetInstance
        {
            get
            {
